        ...
        <>
          <div className="main-container-5">
            <div className="main-descrition-5-5">
              ...
              Americans over 64 years old can claim the 2023 Flex Spending Card that gives them up to $3600. Americans can use the funds to fully cover the cost of their monthly expenses such as Groceries, Rent, Bills and any other expenses they may have! 
              </div>
              <div className="main-des-5"  style={{marginTop:'-5px'}}>
              If you have not yet claimed your monthly Flex then answer the questions below and once approved <b>you will have your $3,600 Flex  Card mailed to you within a few days ready for use!</b>
              </div>
